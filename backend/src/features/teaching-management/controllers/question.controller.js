...
const getQuestionsByCreator = async (req, res) => {
  try {
    ...
    const result = await questionService.getQuestionsByCreator(
      creatorId,
      limit,
      offset,
    );
...
const searchQuestionsByContent = async (req, res) => {
  try {
    ...
    const result = await questionService.searchQuestionsByContent(
      content,
      limit,
      offset,
    );
...
const deleteQuestionsByClassroom = async (req, res) => {
  try {
    ...
    const result =
      await questionService.deleteQuestionsByClassroom(classroomId);
